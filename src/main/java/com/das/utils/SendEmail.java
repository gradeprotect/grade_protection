    ...
    public static void sendEmail(String title, String msg, String receiver) throws MessagingException, GeneralSecurityException {
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("619046217@qq.com", "uqntnndkbnnobffe");
            }
        });
        ...
        //连接服务器
        transport.connect("smtp.qq.com", "751811152@qq.com", "uqntnndkbnnobffe");

        //创建邮件对象
        MimeMessage mimeMessage = new MimeMessage(session);

        //邮件发送人
        mimeMessage.setFrom(new InternetAddress("751811152@qq.com"));
